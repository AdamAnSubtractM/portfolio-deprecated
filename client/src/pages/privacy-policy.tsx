...
import { StyledPageWrapper } from '../styles/LayoutStyles';
    ...
    <StyledPageWrapper background={theme[themeKey].background.main()}>
      <StyledPage themeKey={themeKey}>
        ...
        <p>
          ...
          <A
            to={`https://www.privacypolicygenerator.info/#wizard`}
        ...
        <p>
          ...
          <A
            to={`https://www.privacypolicyonline.com/what-are-cookies/`}
            openInNewTab={true}
            isInternalLink={false}
          >
